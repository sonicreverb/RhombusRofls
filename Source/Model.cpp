...
Rhombus::Rhombus(float x, float y, float size): rotationAngle(10.f), scale(1.f)
{
	shape.setPointCount(4);
	shape.setPoint(0, sf::Vector2f(-size / 2, 0));
	shape.setPoint(1, sf::Vector2f(0, -size));
	shape.setPoint(2, sf::Vector2f(size / 2, 0));
...
void Rhombus::move(float offsetX, float offsetY)
{
	this->shape.move(offsetX, offsetY);
}

void Rhombus::display(sf::RenderWindow& window)
{
...
sf::Color RhombToSfColorAdapter(RhombColors _color)
{
	...
	case RhombColors::Passive1:
		return sf::Color(140, 164, 250, 100);
		break;
	case RhombColors::Passive2:
		return sf::Color(198, 250, 140, 100);
		break;
	case RhombColors::Passive3:
		return sf::Color(250, 164, 140, 100);
		break;
	case RhombColors::Passive4:
		return sf::Color(168, 87, 64, 100);
		break;
	case RhombColors::Passive5:
		return sf::Color(91, 98, 122, 100);
		break;
	case RhombColors::Active:
		return sf::Color(200, 20, 0, 100);
		break;
	default:
		break;
	}
